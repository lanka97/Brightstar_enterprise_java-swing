...
public class SendCustomMail {
     ...
     public static void create_sendEmail(String email){
        ...
        try{
            ...
            String emailContent = "This is 1st warning for pay overdue rents that machine you rented from us.Please pay"
                    + "your within 2 weeks.Otherwise we may take a legal actions against you.Thank you! ";
            String sourceFile = "C:\\Users\\pasan\\Desktop\\Invoice\\warning.pdf";
            String fileName = "WarningLetter.pdf";
