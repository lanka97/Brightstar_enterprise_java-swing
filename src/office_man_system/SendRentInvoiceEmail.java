 ...
 */
public class SendRentInvoiceEmail {
    
     public static void create_sendEmail(String nic,String date, String email){
        ...
        try{
            ...
            String emailContent ="Dear Customer,Pleasure To Hava A Deal. Thank you!";
            String sourceFile = "C:\\Users\\pasan\\Desktop\\Invoice\\" + "Rent Invoice "+date+" "+nic+".pdf";
