 ...
 * @author pasan
 */
public class SendSparepartSaleInvoiceEmail {

    public static void create_sendEmail(String invoiceID, String email) {
        try {
            ...
            String sourceFile = "D:\\PROJECTS\\NetBeans\\BrightStar\\invoices\\Invoice" + invoiceID + ".pdf";
            String fileName = "SparepartSalesReceipt.pdf";
            ...
            Logger.getLogger(SendSparepartSaleInvoiceEmail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
