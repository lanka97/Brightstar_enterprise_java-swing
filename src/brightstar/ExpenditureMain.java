 ...
 * @author Admin
 */
public class ExpenditureMain extends javax.swing.JFrame {

    GridBagLayout layout = new GridBagLayout();
    
    bill cust_panel;
    rent spare_part_panel;
    report report_1;
    other view_spare_partsSales_panel;
    balanceReport Br;
    //SparePartsReportPanel spare_parts_report;
    
    
    
    public ExpenditureMain() throws SQLException {
        initComponents();
        
        cust_panel = new bill();
        spare_part_panel = new rent();
        view_spare_partsSales_panel = new other();
        report_1  = new report();
        Br = new balanceReport();
    ...
    private void initComponents() {
        ...
        DynamicPanel.setFocusCycleRoot(true);
        DynamicPanel.setFocusTraversalPolicyProvider(true);
        DynamicPanel.setPreferredSize(new java.awt.Dimension(1600, 1010));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brightstar/images/icons8_Bill_20px.png"))); // NOI18N
        ...
        sidePanel.add(btn_customer, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 300, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brightstar/images/icons8_Rent_20px_2.png"))); // NOI18N

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Rent & Repares");
        ...
        sidePanel.add(btn_sparepart_sale, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 300, -1));
        ...
        sidePanel.add(btn_view_spareparts_sales, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 300, -1));
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brightstar/images/icons8_Graph_Report_20px.png"))); // NOI18N

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Expenditure Report");
        ...
        sidePanel.add(btn_spareparts_pending, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 300, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brightstar/images/Webp.net-resizeimage (1).png"))); // NOI18N
        sidePanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 240, 70));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/brightstar/images/icons8_Home_52px_1.png"))); // NOI18N
        jLabel4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel4MouseClicked(evt);
            }
        });
        sidePanel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 570, -1, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Balence Report");
        ...
        sidePanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 870, -1, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(sidePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
...
// pending_payments.setVisible(false);
    ...
    private void btn_customerMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_customerMousePressed
        ...
        report_1.setVisible(false);
        view_spare_partsSales_panel.setVisible(false);
        Br.setVisible(false);       // pending_payments.setVisible(false);
...
//            spare_part_panel.setVisible(false);
//            view_spare_partsSales_panel.setVisible(false);
//            report_1.setVisible(false); balanceReport BR = new balanceReport();
//            Br.setVisible(true);
//        } catch (SQLException ex) {
//            Logger.getLogger(ExpenditureMain.class.getName()).log(Level.SEVERE, null, ex);
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpenditureMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ExpenditureMain().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ExpenditureMain.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
